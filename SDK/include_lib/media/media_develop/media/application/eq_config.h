...
void eq_coeff_set(EQ_CFG *eq_cfg, u16 sr, u8 mode, EQ_CFG_SEG *seg, int *tar_tab);
...
int eq_get_filter_info(struct audio_eq *eq, int sr, struct audio_eq_filter_info *info);
int drc_get_filter_info(struct audio_drc *drc, struct audio_drc_filter_info *info);
int aec_ul_eq_filter(struct audio_eq *eq, int sr, struct audio_eq_filter_info *info);
int eq_phone_get_filter_info(struct audio_eq *eq, int sr, struct audio_eq_filter_info *info);
