...
extern const u16 poweroff_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX];
/***********************************************************
 *				adkey table 映射管理
 ***********************************************************/
...
#endif
///2020-11-13
#if 1//USER_CAR_AUDIO_POWER_EN
    [APP_POWEROFF_TASK] = poweroff_key_ad_table,
#endif
...
extern const u16 poweroff_key_ir_table[KEY_IR_NUM_MAX][KEY_EVENT_MAX];
/***********************************************************
 *				irkey table 映射管理
 ***********************************************************/
...
///2020-11-13
#if 1//USER_CAR_AUDIO_POWER_EN
    [APP_POWEROFF_TASK] = poweroff_key_ir_table,
#endif
