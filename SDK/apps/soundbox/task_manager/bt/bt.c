...
int bt_key_event_handler(struct sys_event *event)
{
    ...
    case KEY_IR_NUM_8:
    case KEY_IR_NUM_9:
        bt_key_input_phone_number(key_event - KEY_IR_NUM_0 + '0', (UI_GET_CURR_MENU()==MENU_BT_INPUT_NUMBER?0:1));
        UI_SHOW_MENU(MENU_BT_INPUT_NUMBER, 8000, 0, NULL);
        break;
