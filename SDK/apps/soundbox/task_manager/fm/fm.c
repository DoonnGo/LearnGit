...
static int fm_key_event_opr(struct sys_event *event)
{
    ...
    case KEY_VOL_DOWN:
        fm_volume_down();
        break;
    case KEY_FM_CHANNEL_1:
    case KEY_FM_CHANNEL_2:
    case KEY_FM_CHANNEL_3:
    case KEY_FM_CHANNEL_4:
    case KEY_FM_CHANNEL_5:
    case KEY_FM_CHANNEL_6:
        fm_set_band_channel(key_event - KEY_FM_CHANNEL_1);
        break;
    case KEY_FM_SCHANNEL_1:
    case KEY_FM_SCHANNEL_2:
    case KEY_FM_SCHANNEL_3:
    case KEY_FM_SCHANNEL_4:
    case KEY_FM_SCHANNEL_5:
    case KEY_FM_SCHANNEL_6:
        fm_save_band_channel(key_event - KEY_FM_SCHANNEL_1);
        break;
    case KEY_FM_BAND:
        fm_next_band();
        break;
    case KEY_FM_PREV_STEP_LONG:
        fm_prev_step_long();
        break;
    case KEY_FM_PREV_STEP_HOLD:
        fm_prev_step_hold();
        break;
    case KEY_FM_PREV_STEP_LONGUP:
        fm_prev_step_longup();
        break;
    case KEY_FM_NEXT_STEP_LONG:
        fm_next_step_long();
        break;
    case KEY_FM_NEXT_STEP_HOLD:
        fm_next_step_hold();
        break;
    case KEY_FM_NEXT_STEP_LONGUP:
        fm_next_step_longup();
        break;
    case KEY_FM_AUTO_PLAY:
        fm_auto_play_all_channel();
        break;
