...
void idle_key_poweron_deal(u8 step);
void idle_app_open_module();

#define POWER_ON_CNT       10
/// idle 是否关闭不用的模块，减少功耗
#define LOW_POWER_IN_IDLE    1
...
#if LOW_POWER_IN_IDLE
    is_idle_flag = 0;
#if 0//(TCFG_LOWPOWER_LOWPOWER_SEL == 0)
...
#if 0
    ///2020-11-25 无论U盘是否在线都设置DMDP的上下拉,使即使在ACC时插入U盘也能降低电流
