...
#define LED7_WAV 		BIT(13) 	//13: WAV图标
#define LED7_L1 		BIT(14) 	//14
#define LED7_L2 		BIT(15) 	//15
#define LED7_L3 		BIT(16) 	//16
#define LED7_L4 		BIT(17) 	//17
#define LED7_MID_ 		BIT(18) 	//18: '-'图标
#define LED7_INT 		BIT(19) 	//19: INT图标
#define LED7_RPT 		BIT(20) 	//20: RPT图标
#define LED7_RDM 		BIT(21) 	//21: RDM图标
#define LED7_EQ 		BIT(22) 	//22: EQ图标
#define LED7_POP 		BIT(23) 	//23: POP图标
#define LED7_ROCK 		BIT(24) 	//24: ROCK图标
#define LED7_CLASS 		BIT(25) 	//25: CLASS图标

#define LCDSEG_2POINT   LED7_2POINT
#define LCDSEG_DOT 	    LED7_DOT
#define LCDSEG_FM 	    LED7_FM
#define LCDSEG_USB 	    LED7_USB
#define LCDSEG_SD  	    LED7_SD
#define LCDSEG_MP3 	    LED7_MP3
#define LCDSEG_WMA 	    LED7_WMA
#define LCDSEG_WAV 	    LED7_WAV
#define LCDSEG_PLAY	    LED7_PLAY
#define LCDSEG_L1 	    LED7_L1
#define LCDSEG_L2 	    LED7_L2
#define LCDSEG_L3 	    LED7_L3
#define LCDSEG_L4 	    LED7_L4
#define LCDSEG_MID_ 	LED7_MID_
#define LCDSEG_INT  	LED7_INT
#define LCDSEG_RPT 	    LED7_RPT
#define LCDSEG_RDM 	    LED7_RDM
#define LCDSEG_EQ   	LED7_EQ
#define LCDSEG_POP  	LED7_POP
#define LCDSEG_ROCK 	LED7_ROCK
#define LCDSEG_CLASS 	LED7_CLASS
#define LCDSEG_BT   	LED7_BT
