...
#define ACC_DETECT_EN                       1   ///2020-11-25 ACC处理
#define ACC_DETECT_AD_REUSE_KNOB            1   ///2020-11-25 ACC与编码器复用检测
#define ACC_DETECT_POWERUP_IGNORE_TIME      2000///2020-11-25 上电2S内不检测ACC
//*********************************************************************************//
//                               PCM_DEBUG调试配置                                 //
//*********************************************************************************//
...
#define TCFG_UART0_TX_PORT  				IO_PORT_DP//IO_PORTB_00                            //串口发送脚配置
...
#define TCFG_HW_I2C0_PORTS                  'A'                                     //选择第几组硬件引脚
...
#if TCFG_UART0_ENABLE == ENABLE_THIS_MOUDLE && TCFG_UART0_TX_PORT == IO_PORT_DP
...
#define R_UP    100                 //10K，外部上拉阻值在此自行设置
#else
...
#define TCFG_ADKEY_AD1      (0x3ffL * 7    / (7    + R_UP))     //0k7 (0.75)
#define TCFG_ADKEY_AD2      (0x3ffL * 15   / (15   + R_UP))     //1k5
#define TCFG_ADKEY_AD3      (0x3ffL * 24   / (24   + R_UP))     //2k4
#define TCFG_ADKEY_AD4      (0x3ffL * 33   / (33   + R_UP))     //3k3
#define TCFG_ADKEY_AD5      (0x3ffL * 47   / (47   + R_UP))     //4k7
#define TCFG_ADKEY_AD6      (0x3ffL * 62   / (62   + R_UP))     //6k2
#define TCFG_ADKEY_AD7      (0x3ffL * 82   / (82   + R_UP))     //8k2
#define TCFG_ADKEY_AD8      (0x3ffL * 100  / (100  + R_UP))     //10k
#define TCFG_ADKEY_AD9      (0x3ffL * 120  / (120  + R_UP))     //12k
#define TCFG_ADKEY_AD10     (0x3ffL * 150  / (150  + R_UP))     //15k
#define TCFG_ADKEY_AD11     (0x3ffL * 200  / (200  + R_UP))     //20k
#define TCFG_ADKEY_AD12     (0x3ffL * 270  / (270  + R_UP))     //27k
#define TCFG_ADKEY_AD13     (0x3ffL * 360  / (360  + R_UP))     //36k
#define TCFG_ADKEY_AD14     (0x3ffL * 510  / (510  + R_UP))     //51k
#define TCFG_ADKEY_AD15     (0x3ffL * 750  / (750  + R_UP))     //75k
#define TCFG_ADKEY_AD16     (0x3ffL * 1500 / (1500 + R_UP))     //150k
...
#define TCFG_ADKEY_VOLTAGE10    ((TCFG_ADKEY_AD10+ TCFG_ADKEY_AD11) / 2)
#define TCFG_ADKEY_VOLTAGE11    ((TCFG_ADKEY_AD11+ TCFG_ADKEY_AD12) / 2)
#define TCFG_ADKEY_VOLTAGE12    ((TCFG_ADKEY_AD12+ TCFG_ADKEY_AD13) / 2)
#define TCFG_ADKEY_VOLTAGE13    ((TCFG_ADKEY_AD13+ TCFG_ADKEY_AD14) / 2)
#define TCFG_ADKEY_VOLTAGE14    ((TCFG_ADKEY_AD14+ TCFG_ADKEY_AD15) / 2)
#define TCFG_ADKEY_VOLTAGE15    ((TCFG_ADKEY_AD15+ TCFG_ADKEY_AD16) / 2)
#define TCFG_ADKEY_VOLTAGE16    ((TCFG_ADKEY_AD16+ TCFG_ADKEY_VDDIO) / 2)
...
#define TCFG_ADKEY_VALUE15                  15
#define TCFG_ADKEY_VALUE16                  16

/////2020-11-14 AD2
//#define TCFG_ADKEY2_ENABLE                   ENABLE_THIS_MOUDLE//是否使能AD2按键
//#define TCFG_ADKEY2_PORT                     IO_PORTB_01         //AD2按键端口(需要注意选择的IO口是否支持AD功能)
//#define TCFG_ADKEY2_AD_CHANNEL               AD_CH_PB1
//#define TCFG_ADKEY2_EXTERN_UP_ENABLE         ENABLE_THIS_MOUDLE //是否使用外部上拉
//
////必须从小到大填电阻，没有则同VDDIO,填0x3ffL
//#define TCFG_ADKEY2_AD0      (0)                                 //0R
//#define TCFG_ADKEY2_AD1      (0x3ffL * 7    / (7    + R_UP))     //0k7 (0.75)
//#define TCFG_ADKEY2_AD2      (0x3ffL * 15   / (15   + R_UP))     //1k5
//#define TCFG_ADKEY2_AD3      (0x3ffL * 24   / (24   + R_UP))     //2k4
//#define TCFG_ADKEY2_AD4      (0x3ffL * 33   / (33   + R_UP))     //3k3
//#define TCFG_ADKEY2_AD5      (0x3ffL * 47   / (47   + R_UP))     //4k7
//#define TCFG_ADKEY2_AD6      (0x3ffL * 62   / (62   + R_UP))     //6k2
//#define TCFG_ADKEY2_AD7      (0x3ffL * 82   / (82   + R_UP))     //8k2
//#define TCFG_ADKEY2_AD8      (0x3ffL * 100  / (100  + R_UP))     //10k
//#define TCFG_ADKEY2_AD9      (0x3ffL * 120  / (120  + R_UP))     //12k
//#define TCFG_ADKEY2_AD10     (0x3ffL * 150  / (150  + R_UP))     //15k
//#define TCFG_ADKEY2_AD11     (0x3ffL * 200  / (200  + R_UP))     //20k
//#define TCFG_ADKEY2_AD12     (0x3ffL * 270  / (270  + R_UP))     //27k
//#define TCFG_ADKEY2_AD13     (0x3ffL * 360  / (360  + R_UP))     //36k
//#define TCFG_ADKEY2_AD14     (0x3ffL * 510  / (510  + R_UP))     //51k
//#define TCFG_ADKEY2_AD15     (0x3ffL * 750  / (750  + R_UP))     //75k
//#define TCFG_ADKEY2_AD16     (0x3ffL * 1500 / (1500 + R_UP))     //150k
//#define TCFG_ADKEY2_VDDIO    (0x3ffL)
//
//#define TCFG_ADKEY2_VOLTAGE0     ((TCFG_ADKEY2_AD0 + TCFG_ADKEY2_AD1) / 2)
//#define TCFG_ADKEY2_VOLTAGE1     ((TCFG_ADKEY2_AD1 + TCFG_ADKEY2_AD2) / 2)
//#define TCFG_ADKEY2_VOLTAGE2     ((TCFG_ADKEY2_AD2 + TCFG_ADKEY2_AD3) / 2)
//#define TCFG_ADKEY2_VOLTAGE3     ((TCFG_ADKEY2_AD3 + TCFG_ADKEY2_AD4) / 2)
//#define TCFG_ADKEY2_VOLTAGE4     ((TCFG_ADKEY2_AD4 + TCFG_ADKEY2_AD5) / 2)
//#define TCFG_ADKEY2_VOLTAGE5     ((TCFG_ADKEY2_AD5 + TCFG_ADKEY2_AD6) / 2)
//#define TCFG_ADKEY2_VOLTAGE6     ((TCFG_ADKEY2_AD6 + TCFG_ADKEY2_AD7) / 2)
//#define TCFG_ADKEY2_VOLTAGE7     ((TCFG_ADKEY2_AD7 + TCFG_ADKEY2_AD8) / 2)
//#define TCFG_ADKEY2_VOLTAGE8     ((TCFG_ADKEY2_AD8 + TCFG_ADKEY2_AD9) / 2)
//#define TCFG_ADKEY2_VOLTAGE9     ((TCFG_ADKEY2_AD9 + TCFG_ADKEY2_AD10) / 2)
//#define TCFG_ADKEY2_VOLTAGE10    ((TCFG_ADKEY2_AD10+ TCFG_ADKEY2_AD11) / 2)
//#define TCFG_ADKEY2_VOLTAGE11    ((TCFG_ADKEY2_AD11+ TCFG_ADKEY2_AD12) / 2)
//#define TCFG_ADKEY2_VOLTAGE12    ((TCFG_ADKEY2_AD12+ TCFG_ADKEY2_AD13) / 2)
//#define TCFG_ADKEY2_VOLTAGE13    ((TCFG_ADKEY2_AD13+ TCFG_ADKEY2_AD14) / 2)
//#define TCFG_ADKEY2_VOLTAGE14    ((TCFG_ADKEY2_AD14+ TCFG_ADKEY2_AD15) / 2)
//#define TCFG_ADKEY2_VOLTAGE15    ((TCFG_ADKEY2_AD15+ TCFG_ADKEY2_AD16) / 2)
//#define TCFG_ADKEY2_VOLTAGE16    ((TCFG_ADKEY2_AD16+ TCFG_ADKEY2_VDDIO) / 2)
//
//#define TCFG_ADKEY2_VALUE0                   0
//#define TCFG_ADKEY2_VALUE1                   1
//#define TCFG_ADKEY2_VALUE2                   2
//#define TCFG_ADKEY2_VALUE3                   3
//#define TCFG_ADKEY2_VALUE4                   4
//#define TCFG_ADKEY2_VALUE5                   5
//#define TCFG_ADKEY2_VALUE6                   6
//#define TCFG_ADKEY2_VALUE7                   7
//#define TCFG_ADKEY2_VALUE8                   8
//#define TCFG_ADKEY2_VALUE9                   9
//#define TCFG_ADKEY2_VALUE10                  10
//#define TCFG_ADKEY2_VALUE11                  11
//#define TCFG_ADKEY2_VALUE12                  12
//#define TCFG_ADKEY2_VALUE13                  13
//#define TCFG_ADKEY2_VALUE14                  14
//#define TCFG_ADKEY2_VALUE15                  15
//#define TCFG_ADKEY2_VALUE16                  16

///2020-11-11
#define USER_AD_KNOB_ENABLE                 ENABLE_THIS_MOUDLE      //AD检测编码器
#define USER_AD_KNOB_PORT                   IO_PORTB_01         //AD按键端口(需要注意选择的IO口是否支持AD功能)
#define USER_AD_KNOB_AD_CHANNEL             AD_CH_PB1
#define USER_AD_KNOB_EXTERN_UP_ENABLE       ENABLE_THIS_MOUDLE //是否使用外部上拉

//*********************************************************************************//
//                                 irkey 配置                                      //
//*********************************************************************************//
#define TCFG_IRKEY_ENABLE                   ENABLE_THIS_MOUDLE//是否使能ir按键
#define TCFG_IRKEY_PORT                     IO_PORTB_00        //IR按键端口
...
#define USER_UI_MAX_VOL                     (63)    //使用数字音量时的最大音量级数
#define USER_MUTE_DISABLE()                 do{JL_PORTB->DIR &= ~BIT(2); JL_PORTB->OUT &= ~BIT(2);}while(0);
#define USER_MUTE_ENABLE()                  do{JL_PORTB->DIR &= ~BIT(2); JL_PORTB->OUT |=  BIT(2);}while(0);
//*********************************************************************************//
//                                  充电仓配置                                     //
//*********************************************************************************//
...
#define CONFIG_UI_STYLE                     STYLE_USER_LCDSEG//STYLE_JL_LED7
...
#define USER_UI_LCDSEG_ENABLE               DISABLE_THIS_MOUDLE  //UI使用自定义的LCDSEG直驱
#define USER_UI_1621LCD_ENABLE              ENABLE_THIS_MOUDLE
...
#define TCFG_CLOCK_SYS_HZ					192000000                     //系统时钟设置
...
#undef MIC_AUDIO_RATE_1
#define     MIC_AUDIO_RATE_1              MIC_EFFECT_SAMPLERATE
#endif
...
#define TCFG_LINEIN_DETECT_ENABLE           DISABLE             // linein检测开关
...
#define TCFG_USE_FAKE_RTC                   ENABLE    //假时钟
