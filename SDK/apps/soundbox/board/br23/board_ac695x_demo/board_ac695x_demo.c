...
//	.detect_mode            = SD_CMD_DECT,
    ...
    .power                  = NULL,//sd_set_power,//库函数，使用SDPG引脚。可以自行重写其他的SD卡电源控制函数，传入0：关电源。传入1，开电源。如果电源硬件已固定不可控，则该函数无效，可以填NULL
    /* .power                  = NULL, */
#else
...
const struct adkey_platform_data adkey_data = {
    ...
    .ad_value = {                                             //根据电阻算出来的电压值
        ...
        TCFG_ADKEY_VOLTAGE11,
        TCFG_ADKEY_VOLTAGE12,
        TCFG_ADKEY_VOLTAGE13,
        TCFG_ADKEY_VOLTAGE14,
        TCFG_ADKEY_VOLTAGE15,
        TCFG_ADKEY_VOLTAGE16,
    },
...
LED7_PLATFORM_DATA_BEGIN(lcdseg_data)
	.pin_type = LCDSEG_6x16,
    .pin_cfg.pinCxS.pin_com[0] = IO_PORTC_05,
    .pin_cfg.pinCxS.pin_com[1] = IO_PORTC_04,
    .pin_cfg.pinCxS.pin_com[2] = IO_PORTC_03,
    .pin_cfg.pinCxS.pin_com[3] = IO_PORTC_02,
    .pin_cfg.pinCxS.pin_com[4] = IO_PORTC_01,
    .pin_cfg.pinCxS.pin_com[5] = IO_PORTC_00,

    .pin_cfg.pinCxS.pin_seg[0] = IO_PORTA_12,
    .pin_cfg.pinCxS.pin_seg[1] = IO_PORTA_11,
    .pin_cfg.pinCxS.pin_seg[2] = IO_PORTA_10,
    .pin_cfg.pinCxS.pin_seg[3] = IO_PORTA_09,
    .pin_cfg.pinCxS.pin_seg[4] = IO_PORTA_08,
    .pin_cfg.pinCxS.pin_seg[5] = IO_PORTA_07,
    .pin_cfg.pinCxS.pin_seg[6] = IO_PORTA_06,
    .pin_cfg.pinCxS.pin_seg[7] = IO_PORTA_05,
    .pin_cfg.pinCxS.pin_seg[8] = IO_PORTA_04,
    .pin_cfg.pinCxS.pin_seg[9] = IO_PORTA_03,
    .pin_cfg.pinCxS.pin_seg[10] = IO_PORTA_02,
    .pin_cfg.pinCxS.pin_seg[11] = IO_PORTA_01,
    .pin_cfg.pinCxS.pin_seg[12] = IO_PORTA_00,
    .pin_cfg.pinCxS.pin_seg[13] = IO_PORTC_07,
    .pin_cfg.pinCxS.pin_seg[14] = IO_PORTB_05,
    .pin_cfg.pinCxS.pin_seg[15] = IO_PORTB_04,
LED7_PLATFORM_DATA_END()

const struct ui_devices_cfg ui_cfg_data = {
	.type = LCDSEG,
	.private_data = (void *)&lcdseg_data,
};
...
#endif /* #if USER_UI_LCDSEG_ENABLE */
...
/* #endif */
    ...
    ///关闭上电默认的PB1低电平8s复位功能, 2020-11-11
