#ifndef CONFIG_BOARD_AC695E_LIGHTER_CFG_H
#define CONFIG_BOARD_AC695E_LIGHTER_CFG_H
...
//*********************************************************************************//
//                                 UART配置(使用PB1打印需要注意长按复位问题)                                        //
//*********************************************************************************//
#define TCFG_UART0_ENABLE					ENABLE_THIS_MOUDLE                     //串口打印模块使能
#define TCFG_UART0_RX_PORT					NO_CONFIG_PORT                         //串口接收脚配置（用于打印可以选择NO_CONFIG_PORT）
#define TCFG_UART0_TX_PORT  				IO_PORTB_01                            //串口发送脚配置
...
#define TCFG_IOKEY_POWER_ONE_PORT			IO_PORTA_05        //IO按键端口

#define TCFG_IOKEY_PREV_CONNECT_WAY			ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_PREV_ONE_PORT			IO_PORTC_05

#define TCFG_IOKEY_NEXT_CONNECT_WAY 		ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_NEXT_ONE_PORT			IO_PORTA_09

#define TCFG_IOKEY_MODE_CONNECT_WAY			DOUBLE_PORT_TO_IO
#define TCFG_IOKEY_MODE_TWO_PORT_IN			IO_PORTA_05        //IO按键端口
#define TCFG_IOKEY_MODE_TWO_PORT_OUT		IO_PORTA_09        //IO按键端口


#define TCFG_IO_MULTIPLEX_WITH_SD		ENABLE 				 // IO_KEY与 SD_CLK复用
#define TCFG_MULTIPLEX_PORT		        TCFG_IOKEY_PREV_ONE_PORT // 复用的引脚
...
#define TCFG_IRKEY_PORT                     IO_PORTB_01        //IR按键端口
...
//                                 rdec_key 配置                                      //
//*********************************************************************************//
#define TCFG_RDEC_KEY_ENABLE		  			DISABLE_THIS_MOUDLE //是否使能IO按键
//默认硬件引脚配置
//RDEC0配置
...
#define AUDIO_OUTPUT_WAY            AUDIO_OUTPUT_WAY_FM
...
#define CONFIG_UI_STYLE                     STYLE_JL_LED7           //ui风格
#define TCFG_TFT_LCD_DEV_SPI_HW_NUM			 1// 1: SPI1    2: SPI2 配置lcd选择的spi口
#define TCFG_UI_LED1888_ENABLE				ENABLE_THIS_MOUDLE  //UI使用LED1888
...
//                                  REC 配置                                       //
//*********************************************************************************//
#define RECORDER_MIX_EN						ENABLE//混合录音使能
...
#define TCFG_LINEIN_AD_CHANNEL             	AD_CH_PC4//NO_CONFIG_PORT		// 检测IO是否使用AD检测
...
#define TCFG_LINEIN_SD_PORT		            1// 0:sd0 1:sd1     //选择复用的sd
...
//                                  fm emitter 配置                                     //
//*********************************************************************************//
#define TCFG_APP_FM_EMITTER_EN                  ENABLE_THIS_MOUDLE
#define TCFG_FM_EMITTER_INSIDE_ENABLE			ENABLE
...
#define TCFG_USE_FAKE_RTC                   0//ENABLE    //假时钟
//*********************************************************************************//
//                                  SPDIF & ARC 配置                                     //
//*********************************************************************************//
