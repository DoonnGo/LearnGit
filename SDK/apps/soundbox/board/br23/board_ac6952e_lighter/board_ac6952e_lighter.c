...
const struct iokey_port iokey_list[] = {
    ...
    {
        .connect_way = TCFG_IOKEY_MODE_CONNECT_WAY,
		.key_type.two_io.in_port  = TCFG_IOKEY_MODE_TWO_PORT_IN,
		.key_type.two_io.out_port = TCFG_IOKEY_MODE_TWO_PORT_OUT,
        .key_value = 3,
    },
};
...
LED7_PLATFORM_DATA_BEGIN(led7_data)
	.pin_type = LED7_PIN7,
	.pin_cfg.pin7.pin[0] = IO_PORTA_10,
	.pin_cfg.pin7.pin[1] = IO_PORTB_09,
	.pin_cfg.pin7.pin[2] = IO_PORTB_08,
	.pin_cfg.pin7.pin[3] = IO_PORTB_07,
	.pin_cfg.pin7.pin[4] = IO_PORTB_06,
	.pin_cfg.pin7.pin[5] = IO_PORTB_04,
...
static void board_devices_init(void)
{
    ...
    ui_set_led(MENU_LED0, 1, 1, 250, 500);
    ui_set_led(MENU_LED1, 1, 0, 250, 500);
#endif


#if  TCFG_APP_FM_EMITTER_EN
 	fm_emitter_manage_init(0);
#endif
