#ifndef CONFIG_BOARD_AC695X_CHARGING_BIN_H
#define CONFIG_BOARD_AC695X_CHARGING_BIN_H
...
#define MIX_OUTPUT_DUAL_TO_QUAD_TYPE 								(MIX_OUTPUT_DUAL_TO_QUAD_TYPE_COPY_ONLY)
...
#define TCFG_UART0_TX_PORT  				IO_PORTC_01                            //串口发送脚配置
...
#define TCFG_NOR_FS_ENABLE                  0//ENABLE
#else
...
//*********************************************************************************//
//是否支持充电盒(作为盒子使用)
#define TCFG_CHARGE_BOX_ENABLE                        1//DISABLE_THIS_MOUDLE

#if(TCFG_CHARGE_BOX_ENABLE)
#define WIRELESS_ENABLE                                ENABLE_THIS_MOUDLE        //是否支持无线充
#define TCFG_CHARGE_BOX_SOFT_POWER_OFF_IO_CTRL_ENABLE  ENABLE_THIS_MOUDLE       //一些外设（如某些升压芯片）休眠时需要设置上下拉来维持关闭态
#else
#define WIRELESS_ENABLE                                DISABLE_THIS_MOUDLE
#define TCFG_CHARGE_BOX_SOFT_POWER_OFF_IO_CTRL_ENABLE  DISABLE_THIS_MOUDLE
#endif

#define TCFG_HALL_OPEN_STATUS                          1                  //开盖时电平(1高电平 0低电平)
#define TCFG_HALL_PORT                                 IO_PORTB_00        //hall 传感器的IO

///注意out/inputchannel 冲突问题
#define TCFG_CHARGEBOX_L_PORT                          IO_PORTB_05        //充电盒和左耳通信的IO口需要为高压IO
#define TCFG_CHARGEBOX_R_PORT                          IO_PORTB_02        //充电盒和右耳通信的IO口需要为高压IO

//如果使用iic与充电IC通信
#define TCFG_CHARGE_IC_USER_IIC_TYPE        0                  //0:软件IIC  1:硬件IIC
...
#define    MUTIl_CHARGING_BOX_EN        1
#endif


#ifdef JL_SMART_BOX_CUSTOM_APP_EN
#define SMARTBOX_SPP_INTERACTIVE_SUPPORT    0
...
#endif //CONFIG_BOARD_AC695X_CHARGING_BIN_H
