...
const struct iokey_port iokey_list[] = {
    {
        ...
        .key_value = 0|BIT(7),                                       //按键值
    },
    {
        .connect_way = ONE_PORT_TO_LOW,          //IO按键的连接方式
        .key_type.one_io.port = TCFG_IOKEY_KEY1_ONE_PORT,    //IO按键对应的引脚
        .key_value = 1|BIT(7),                                       //按键值
    },
    {
        .connect_way = ONE_PORT_TO_LOW,          //IO按键的连接方式
        .key_type.one_io.port = TCFG_IOKEY_KEY2_ONE_PORT,    //IO按键对应的引脚
        .key_value = 2|BIT(7),                                       //按键值
    },
    {
        .connect_way = ONE_PORT_TO_LOW,          //IO按键的连接方式
        .key_type.one_io.port = TCFG_IOKEY_KEY3_ONE_PORT,    //IO按键对应的引脚
        .key_value = 3|BIT(7),                                       //按键值
    },
    {
        .connect_way = ONE_PORT_TO_LOW,          //IO按键的连接方式
        .key_type.one_io.port = TCFG_IOKEY_KEY4_ONE_PORT,    //IO按键对应的引脚
        .key_value = 4|BIT(7),                                       //按键值
    },
    {
        .connect_way = ONE_PORT_TO_LOW,          //IO按键的连接方式
        .key_type.one_io.port = TCFG_IOKEY_KEY5_ONE_PORT,    //IO按键对应的引脚
        .key_value = 5|BIT(7),                                       //按键值
    },
    {
        .connect_way = ONE_PORT_TO_LOW,          //IO按键的连接方式
        .key_type.one_io.port = TCFG_IOKEY_KEY6_ONE_PORT,    //IO按键对应的引脚
        .key_value = 6|BIT(7),                                       //按键值
    },
    {
        .connect_way = DOUBLE_PORT_TO_IO,          //IO按键的连接方式
        .key_type.two_io.in_port = TCFG_IOKEY_KEY1_ONE_PORT,    //IO按键对应的引脚
        .key_type.two_io.out_port = TCFG_IOKEY_KEY2_ONE_PORT,    //IO按键对应的引脚
        .key_value = 7|BIT(7),                                       //按键值
    },
    {
        .connect_way = DOUBLE_PORT_TO_IO,          //IO按键的连接方式
        .key_type.two_io.in_port = TCFG_IOKEY_KEY1_ONE_PORT,    //IO按键对应的引脚
        .key_type.two_io.out_port = TCFG_IOKEY_KEY3_ONE_PORT,    //IO按键对应的引脚
        .key_value = 8|BIT(7),                                       //按键值
    },
    {
        .connect_way = DOUBLE_PORT_TO_IO,          //IO按键的连接方式
        .key_type.two_io.in_port = TCFG_IOKEY_KEY1_ONE_PORT,    //IO按键对应的引脚
        .key_type.two_io.out_port = TCFG_IOKEY_KEY4_ONE_PORT,    //IO按键对应的引脚
        .key_value = 9|BIT(7),                                       //按键值
    },
    {
        .connect_way = DOUBLE_PORT_TO_IO,          //IO按键的连接方式
        .key_type.two_io.in_port = TCFG_IOKEY_KEY1_ONE_PORT,    //IO按键对应的引脚
        .key_type.two_io.out_port = TCFG_IOKEY_KEY5_ONE_PORT,    //IO按键对应的引脚
        .key_value = 10|BIT(7),                                       //按键值
    },
    {
        .connect_way = DOUBLE_PORT_TO_IO,          //IO按键的连接方式
        .key_type.two_io.in_port = TCFG_IOKEY_KEY1_ONE_PORT,    //IO按键对应的引脚
        .key_type.two_io.out_port = TCFG_IOKEY_KEY6_ONE_PORT,    //IO按键对应的引脚
        .key_value = 11|BIT(7),                                       //按键值
    },
    {
        .connect_way = DOUBLE_PORT_TO_IO,          //IO按键的连接方式
        .key_type.two_io.in_port = TCFG_IOKEY_KEY2_ONE_PORT,    //IO按键对应的引脚
        .key_type.two_io.out_port = TCFG_IOKEY_KEY3_ONE_PORT,    //IO按键对应的引脚
        .key_value = 12|BIT(7),                                       //按键值
    },
    {
        .connect_way = DOUBLE_PORT_TO_IO,          //IO按键的连接方式
        .key_type.two_io.in_port = TCFG_IOKEY_KEY2_ONE_PORT,    //IO按键对应的引脚
        .key_type.two_io.out_port = TCFG_IOKEY_KEY4_ONE_PORT,    //IO按键对应的引脚
        .key_value = 13|BIT(7),                                       //按键值
    },
    {
        .connect_way = DOUBLE_PORT_TO_IO,          //IO按键的连接方式
        .key_type.two_io.in_port = TCFG_IOKEY_KEY2_ONE_PORT,    //IO按键对应的引脚
        .key_type.two_io.out_port = TCFG_IOKEY_KEY5_ONE_PORT,    //IO按键对应的引脚
        .key_value = 14|BIT(7),                                       //按键值
    },
    {
        .connect_way = DOUBLE_PORT_TO_IO,          //IO按键的连接方式
        .key_type.two_io.in_port = TCFG_IOKEY_KEY2_ONE_PORT,    //IO按键对应的引脚
        .key_type.two_io.out_port = TCFG_IOKEY_KEY6_ONE_PORT,    //IO按键对应的引脚
        .key_value = 15|BIT(7),                                       //按键值
    },
    {
        .connect_way = DOUBLE_PORT_TO_IO,          //IO按键的连接方式
        .key_type.two_io.in_port = TCFG_IOKEY_KEY3_ONE_PORT,    //IO按键对应的引脚
        .key_type.two_io.out_port = TCFG_IOKEY_KEY4_ONE_PORT,    //IO按键对应的引脚
        .key_value = 16|BIT(7),                                       //按键值
    },
    {
        .connect_way = DOUBLE_PORT_TO_IO,          //IO按键的连接方式
        .key_type.two_io.in_port = TCFG_IOKEY_KEY3_ONE_PORT,    //IO按键对应的引脚
        .key_type.two_io.out_port = TCFG_IOKEY_KEY5_ONE_PORT,    //IO按键对应的引脚
        .key_value = 17|BIT(7),                                       //按键值
    },
    {
        .connect_way = DOUBLE_PORT_TO_IO,          //IO按键的连接方式
        .key_type.two_io.in_port = TCFG_IOKEY_KEY3_ONE_PORT,    //IO按键对应的引脚
        .key_type.two_io.out_port = TCFG_IOKEY_KEY6_ONE_PORT,    //IO按键对应的引脚
        .key_value = 18|BIT(7),                                       //按键值
    },
};
...
const struct slidekey_port slidekey_list[] = {
    {
        .io = IO_PORTB_04,
        .io_up_en = 0,
        .level = 10,
        .ad_channel = AD_CH_PB4,
        .msg = USER_MSG_SYS_SOUNDCARD_SLIDE_MIC,
    },
    {
        .io = IO_PORTA_05,
        .io_up_en = 0,
        .level = 10,
        .ad_channel = AD_CH_PA5,
        .msg = USER_MSG_SYS_SOUNDCARD_SLIDE_ECHO,
    },
    {
        .io = IO_PORTC_05,
        .io_up_en = 0,
        .level = 10,
        .ad_channel = AD_CH_PC5,
        .msg = USER_MSG_SYS_SOUNDCARD_SLIDE_TREBLE,
    },
    {
        .io = IO_PORTC_04,
        .io_up_en = 0,
        .level = 10,
        .ad_channel = AD_CH_PC4,
        .msg = USER_MSG_SYS_SOUNDCARD_SLIDE_BASS,
    },
    {
        .io = IO_PORTA_12,
        .io_up_en = 0,
        .level = 30,
        .ad_channel = AD_CH_PA12,
        .msg = USER_MSG_SYS_SOUNDCARD_SLIDE_REC_VOL,
    },
    {
        .io = IO_PORTA_10,
        .io_up_en = 0,
        .level = 30,
        .ad_channel = AD_CH_PA10,
        .msg = USER_MSG_SYS_SOUNDCARD_SLIDE_MUSIC_VOL,
    },
    {
        .io = IO_PORTB_03,
        .io_up_en = 0,
        .level = 30,
        .ad_channel = AD_CH_PB3,
        .msg = USER_MSG_SYS_SOUNDCARD_SLIDE_EAR_VOL,
    },
};
const struct slidekey_platform_data slidekey_data = {
    .enable = 1,
    .num = ARRAY_SIZE(slidekey_list),
    .port = slidekey_list,
};
...
#if 1 //(TCFG_SD0_ENABLE || TCFG_SD1_ENABLE)
	sdpg_config(0);
#endif
...
extern s8 soundcard_audio_get_volume(u8 ch);
static u8 soundcard_d_vol_get_music_default(void)
{
	return soundcard_audio_get_volume(1);
}

static u8 soundcard_d_vol_get_reverb_default(void)
{
	return soundcard_audio_get_volume(0);
}

static u8 a2dp_d_vol_get_max(void)
{
	return 100;
}

void dec_board_param_init(void)
{
	struct dec_board_param *p;
	list_for_each_dec_board_param(p)
	{
		printf("dec_param name = %s\n", p->name);
		if(strcmp(p->name, "a2dp_dec_param") == 0)
		{
		printf("%s\n", p->name);
			p->d_vol_en = 1;
			p->d_vol_max = a2dp_d_vol_get_max;
			p->d_vol_cur = soundcard_d_vol_get_music_default;
			p->d_vol_fade_step = 2;
		}
		if(strcmp(p->name, "file_dec_param") == 0)
		{
		printf("%s\n", p->name);
			p->d_vol_en = 1;
			p->d_vol_max = a2dp_d_vol_get_max;
		...
		if(strcmp(p->name, "fm_dec_param") == 0)
		{
			p->d_vol_en = 1;
			p->d_vol_max = a2dp_d_vol_get_max;
			p->d_vol_cur = soundcard_d_vol_get_music_default;
		...
		if(strcmp(p->name, "linein_dec_param") == 0)
		{
			p->d_vol_en = 1;
			p->d_vol_max = a2dp_d_vol_get_max;
			p->d_vol_cur = soundcard_d_vol_get_music_default;
		...
		if(strcmp(p->name, "pc_dec_param") == 0)
		{
			p->d_vol_en = 1;
			p->d_vol_max = a2dp_d_vol_get_max;
			p->d_vol_cur = soundcard_d_vol_get_music_default;
		...
		if(strcmp(p->name, "spdif_dec_param") == 0)
		{
			p->d_vol_en = 1;
			p->d_vol_max = a2dp_d_vol_get_max;
			p->d_vol_cur = soundcard_d_vol_get_music_default;
		...
		if(strcmp(p->name, "reverb_dec_param") == 0)
		{
			p->d_vol_en = 1;
			p->d_vol_max = a2dp_d_vol_get_max;
			p->d_vol_cur = soundcard_d_vol_get_reverb_default;
			p->d_vol_fade_step = 2;
		}
		if(strcmp(p->name, "tone_dec_param") == 0)
		{
			p->d_vol_en = 1;
			p->d_vol_max = a2dp_d_vol_get_max;
			p->d_vol_cur = soundcard_d_vol_get_music_default;
...
early_initcall(dec_board_param_init);
