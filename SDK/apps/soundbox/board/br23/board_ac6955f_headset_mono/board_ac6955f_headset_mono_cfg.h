#ifndef CONFIG_BOARD_AC6955F_HEADSET_MONO_CFG_H
#define CONFIG_BOARD_AC6955F_HEADSET_MONO_CFG_H

#ifdef CONFIG_BOARD_AC6955F_HEADSET_MONO
...
#define TCFG_PWMLED_PIN						IO_PORTA_00					//LED使用的IO口
...
#define TCFG_LINEIN_CHECK_PORT				IO_PORTA_01			// linein检测IO
#define TCFG_LINEIN_PORT_UP_ENABLE        	0					// 检测IO上拉使能
#define TCFG_LINEIN_PORT_DOWN_ENABLE       	0					// 检测IO下拉使能
#define TCFG_LINEIN_AD_CHANNEL             	AD_CH_PA1		// 检测IO是否使用AD检测
#define TCFG_LINEIN_VOLTAGE                	960					// AD检测时的阀值
