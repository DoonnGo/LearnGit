#ifndef CONFIG_BOARD_AC695X_TWS_BOX_CFG_H
#define CONFIG_BOARD_AC695X_TWS_BOX_CFG_H
...
#define CONFIG_LOCAL_TWS_ENABLE				1

#if (TCFG_USER_TWS_ENABLE && TCFG_BLUETOOTH_BACK_MODE) && (TCFG_BT_SNIFF_ENABLE==0) && (CONFIG_LOCAL_TWS_ENABLE)
