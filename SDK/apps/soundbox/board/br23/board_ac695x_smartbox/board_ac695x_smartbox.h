#ifndef CONFIG_BOARD_AC695X_SMARTBOX_CFG_H
#define CONFIG_BOARD_AC695X_SMARTBOX_CFG_H

#ifdef CONFIG_BOARD_AC695X_SMARTBOX
...
#define TCFG_MUSIC_MODE_EQ_ENABLE           TCFG_APP_MUSIC_EN     //支持音乐模式EQ
#define TCFG_LINEIN_MODE_EQ_ENABLE          TCFG_APP_LINEIN_EN     //支持linein近端EQ
#define TCFG_FM_MODE_EQ_ENABLE              TCFG_APP_FM_EN     //支持fm模式EQ
#define TCFG_SPDIF_MODE_EQ_ENABLE           TCFG_APP_SPDIF_EN     //支持SPDIF模式EQ
#define TCFG_PC_MODE_EQ_ENABLE              TCFG_APP_PC_EN     //支持pc模式EQ
#define TCFG_AUDIO_OUT_EQ_ENABLE			1 	  //mix_out后高低音EQ
...
#define TCFG_AUDIO_OUT_DRC_ENABLE			1 	  //mix_out后drc
...
#define CONFIG_TIDY_CODE_DEBUG   //工程整理代码导致编译不过，加一下调试代码让工程编译通过
...
//                                  REC 配置                                       //
//*********************************************************************************//
#define RECORDER_MIX_EN						TCFG_APP_RECORD_EN//混合录音使能
#define TCFG_RECORD_FOLDER_DEV_ENABLE       DISABLE//APP不允许使用该配置
